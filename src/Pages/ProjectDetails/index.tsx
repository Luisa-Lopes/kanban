  ...
  sprints: [
    {
      ...
      tasks: {
        ToDo: [
          {
            id: "1",
            text: "Definir arquitetura do sistema",
          },
        ],
        ...
        InProgress: [
          {
            id: "2",
            text: "Mapear requisitos com o cliente",
          },
        ],
        ...
        Done: [
          {
            id: "3",
            text: "Criar cronograma do projeto",
          },
          {
            id: "4",
            text: "Definir stack tecnológica",
          },
        ],
      },
    },

    {
      ...
      tasks: {
        ToDo: [
          {
            id: "5",
            text: "Criar versão mobile do protótipo",
          },
        ],
        ...
        InProgress: [
          {
            id: "6",
            text: "Desenvolver design system",
          },
        ],
        ...
        Done: [
          ...
          {
            id: "8",
            text: "Validar protótipo com cliente",
          },
        ],
      },
    },

    {
      ...
      tasks: {
        ToDo: [
          {
            id: "9",
            text: "Implementar dashboard de métricas",
          },
          {
            id: "10",
            text: "Criar página de equipes",
          },
        ],
        ...
        InProgress: [
          {
            id: "11",
            text: "Desenvolver componente Kanban",
          },
        ],
        ...
        Done: [
          {
            id: "12",
            text: "Configurar projeto React + Vite",
          },
          {
            id: "13",
      ...
      <main className="p-6 flex flex-col gap-6">
        ...
        <section className="grid grid-cols-2  lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-lg shadow-md">
            ...
            <h2 className="text-3xl font-bold">{project.metrics.totalTasks}</h2>
          </div>
        ...
        {/* Sprints */}
        <section className="bg-white rounded-lg p-6 shadow-sm">
          <h2 className="text-xl font-semibold mb-5">Sprints</h2>
